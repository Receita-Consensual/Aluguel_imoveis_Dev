  ...
  return (
    <>
      <button
        ...
        className="lg:hidden fixed bottom-4 left-1/2 -translate-x-1/2 z-[1001] flex items-center gap-2 px-5 py-2.5 bg-blue-500 shadow-lg shadow-blue-200/50 rounded-full text-sm font-semibold text-white hover:bg-blue-600 transition-all active:scale-95"
      >
